...
const UsuarioComponent = () => {
    ...
    const handleOnClick2 = useCallback(() => navigate('/reportes', { replace: true }, [navigate]));
        ...
        <div className="container mt-4">
            <div className='row'>
                ...
                <div>
                    ...
                    <button type="buttom" className="btn btn-outline-primary me-2" onClick={handleOnClick2}>Ir a Reportes</button>
                </div>
